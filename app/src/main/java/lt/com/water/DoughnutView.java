...
public class DoughnutView extends View {
    ...
    private int[] doughnutColors = new int[]{Color.parseColor("#6495ED"),Color.parseColor("#7FFF00"),Color.parseColor("#FFD700"),Color.parseColor("#DC143C")};
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //画背景白色圆环
        initPaint();
        float doughnutWidth = Math.min(width, height) / 2 * 0.14f;
        ...
        canvas.drawText((int) (currentValue / 360f * 100) + name, width / 2, baseLine, paint);
